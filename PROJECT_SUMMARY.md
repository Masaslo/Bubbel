...
- 1 september 2026: de officiële DeepFilterNet3-modelbundle is vastgezet met SHA-256/licentie/metadata en een onafhankelijke synthetische golden vector. Een app-owned, panic-afgevangen Rust C-ABI valideert pointers en 480-sample lengtes en reconstrueert bij reset de volledige `DfTract`. Zowel x86_64 als arm64-v8a bouwen met NDK r28c/API 24; Rust-contracttests, Gradle-unit/APK-build en de x86_64-emulator golden/reset-test zijn groen. Inference blijft voor de volgende stap uitsluitend bestemd voor een worker-thread buiten de Oboe-callback.
